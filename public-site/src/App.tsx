        ...
        <div className="relative mx-auto flex min-h-[92vh] max-w-[1500px] flex-col px-4 py-5 sm:px-6 lg:px-8">
          ...
          <div className="grid flex-1 items-center gap-12 py-16 lg:grid-cols-[1fr_auto_1fr] lg:py-10">
            ...
            <div className="mx-auto max-w-xl text-center">
              <p className="font-mono text-[11px] uppercase tracking-[0.34em] text-[#d6e9ef]">Coming Soon</p>
            ...
            <div className="ml-auto max-w-xs self-center text-right text-sm leading-6 text-white/78">
              <p>
                The public-facing experience is being prepared now. A fuller demo will follow once the product
                surface is ready to share.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-start justify-between gap-6 border-t border-white/15 pt-5 text-white sm:flex-row sm:items-center">
            ...
            <button
              className="inline-flex items-center justify-center rounded-none bg-[#1B5E20] px-8 py-6 text-xs uppercase tracking-[0.26em] text-white transition-colors hover:brightness-110"
              type="button"
            >
              Demo Coming Soon
          ...
          <div className="flex min-h-[560px] flex-col justify-between py-12 lg:py-16">
            <div>
              ...
              <p className="mt-6 max-w-md text-sm leading-7 text-white/72">
                The public demo is coming soon. Start from the landing page and prepare for a map-first product
                experience where imports, paths, and terrain context become one continuous story.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-0 border border-white/10">
              <div className="min-w-[260px] flex-1 bg-[#8d1d0d] p-6">
                ...
                <p className="mt-4 text-xl uppercase tracking-[0.04em] text-white">Public demo coming soon</p>
                <p className="mt-4 text-sm leading-7 text-white/78">
                  The current public site is a placeholder while the full product surface is being prepared.
                </p>
                <button
                  className="mt-6 inline-flex items-center justify-center rounded-none border border-white/20 px-0 text-xs uppercase tracking-[0.22em] text-white transition-colors hover:bg-transparent hover:text-white"
                  type="button"
                >
                  Stay Tuned
                  <ArrowRight className="ml-3 h-4 w-4" />
